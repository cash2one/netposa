...
import {AlarmResponse,AlarmGroupByDay} from "../../totalFactory/totalResponse"
...
class AlarmTrendController {
    ...
    constructor($scope: any, totalService: ITotalService, echartService:IEchartService,areaService:IAreaService, $timeout:any) {
        ...
        // 点击当前节点时获取节点信息  树会初始化会调用treeSelectNode一次
        ...
        function formatDataList(originalData:AlarmResponse) {
            let allAlarmNum:Array<any> = [];
            let area:Array<any> = [];
            let validAlarmNum:Array<any> = [];

            originalData.GROUP_BY_DAY.forEach(function (item:AlarmGroupByDay, index:number) {
...
app.controller('alarmTrendController', AlarmTrendController);