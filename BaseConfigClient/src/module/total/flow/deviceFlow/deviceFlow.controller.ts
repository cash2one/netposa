...
import {FlowResponse,FlowGroupByCamera} from "../../totalFactory/totalResponse"
...
class DeviceFlowController{
    ...
    constructor($scope: any, totalService: ITotalService, echartService:IEchartService,areaService:IAreaService, $timeout:any) {
        ...
        function formatDataList(originalData:FlowResponse) {
            ...
            originalData.GROUP_BY_CAMERA.forEach(function (item:FlowGroupByCamera, index:number) {
...
app.controller('deviceFlowController', DeviceFlowController);