...
import 'css!./style/tplCollectDetail.css';
import { wifi } from '../../resourceRetrieval/resourceRetrievalEnum';
declare let $: any;

class CollectDetailController {
...
app.controller('collectDetailController', CollectDetailController);