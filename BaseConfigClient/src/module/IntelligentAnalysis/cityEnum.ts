...
export const Citys:Array<{code:string,name:string,parent_code:string}> = [
...
export const NationLib:Array<{id:string,name:string}>  = [
    {
        "id": "01",
        "name": "汉族"
    },
...
export function compileCity(code:string):Array<{code:string,name:string,parent_code:string}>{
