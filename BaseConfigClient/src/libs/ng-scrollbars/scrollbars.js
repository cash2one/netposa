...
(function () {
  ...
  function ScrollBarsProvider() {
    ...
    $.mCustomScrollbar.defaults.setLeft = this.defaults.setLeft;
    $.mCustomScrollbar.defaults.scrollInertia = this.defaults.scrollInertia;
    $.mCustomScrollbar.defaults.theme = this.defaults.theme;
    $.mCustomScrollbar.defaults.advanced = this.defaults.advanced;
    $.mCustomScrollbar.defaults.mouseWheel.scrollAmount =this.defaults.mouseWheel.scrollAmount;
