...
class CameraService {
    constructor() {
        this.LOGGER = log4js.getLogger("CameraService");
    }
    edit(models) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let oldModelRes = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.CameraDao).findByID(models.ID);
            ...
            let r1 = yield CameraService.updateCamera(model);
            let r2, r3;
            ...
            if (p && p.length > 0) {
                p.forEach((item) => {
                    item.Lat = point.Lat;
                    item.Lon = point.Lon;
                    item.LayerType = models.CameraType ? models.CameraType : LayerType_1.LayerType.Camera.value;
                    item.ObjectType = ObjectType_1.ObjectType.Camera.value;
                });
                ...
                newpoint.LayerType = model.CameraType ? model.CameraType : LayerType_1.LayerType.Camera.value;
                newpoint.ObjectType = ObjectType_1.ObjectType.Camera.value;
            ...
            if (r && r.length > 0) {
                ...
                newRelation.RelatedObjectType = Table_Map_1.TableMap.Camera;
                newRelation.Type = ObjectType_1.ObjectType.Camera.value;
    ...
    changeAreaId(models) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let cameras = yield CameraService.getCameraForIds(ids);
            cameras.forEach((item) => {
                item.AreaID = maps[item.ID].areaId;
            });
            let result = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.CameraDao).updateList(cameras, BDaoImpl_1.ServerType.BCS);
            if (!result) {
                this.LOGGER.error(util.format("updata error %j", result));
                return Promise.reject(ErrorCode_1.default.ERROR_CAMERA_CHANGE_CAMERA_TYPE_NOT_CATCH_CAMERA);
            }
            return true;
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            models.forEach((model) => __awaiter(this, void 0, void 0, function* () {
                if (model.deviceReId) {
                    ...
                    relation.RelatedObjectId = model.id;
                    relation.RelatedObjectType = Table_Map_1.TableMap.Camera;
                    relation.Type = ObjectType_1.ObjectType.Camera.value;
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            let res = yield Promise.all([
                Camera_1.default.getPosaDPJavaCache(),
    ...
    getPlayerInfoByID(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resc = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.CameraDao).findByID(id);
            if (resc.code !== 200 || !resc.data) {
                return Promise.reject(ErrorCode_1.default.ERROR_CAMERA_CHANGE_CAMERA_TYPE_NOT_CATCH_CAMERA);
            }
            let serverId = resc.data.VideoServer;
            let ress = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.VideoServerDao).findByID(serverId);
    ...
    static getCameraForIds(ids) {
        return BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.CameraDao).findListByID(ids)
            .then((res) => {
            return res.data;
        });
    }
    static updateCamera(model) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.CameraDao).update(model, BDaoImpl_1.ServerType.BCS)
