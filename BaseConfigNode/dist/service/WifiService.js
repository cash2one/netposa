...
class WifiService {
    constructor() {
        this.LOGGER = log4js.getLogger("WifiService");
    }
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            let res = yield Promise.all([
                Wifi_1.default.getPosaDPJavaCache(),
    ...
    edit(models) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let r1 = yield WifiService.updateWifi(model);
            let r2, r3;
            ...
            if (p && p.length > 0) {
                ...
                newpoint.LayerType = LayerType_1.LayerType.WiFi.value;
                newpoint.ObjectType = ObjectType_1.ObjectType.Wifi.value;
            ...
            if (r && r.length > 0) {
                ...
                newRelation.Type = ObjectType_1.ObjectType.Wifi.value;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            models.forEach((model) => __awaiter(this, void 0, void 0, function* () {
                if (model.deviceReId) {
                    ...
                    relation.Type = ObjectType_1.ObjectType.Wifi.value;
    ...
    changeAreaId(models) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let wifiList = yield WifiService.getWifiForIds(ids);
            wifiList.forEach((item) => {
                item.AreaID = maps[item.ID].areaId;
            });
            let result = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.RfidDao).updateList(wifiList);
            if (!result) {
    ...
    static updateWifi(model) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.RfidDao).update(model).then((res) => __awaiter(this, void 0, void 0, function* () {
                return res.data;
            }));
        });
    }
    static getWifiForIds(ids) {
        return BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.RfidDao).findListByID(ids).then((res) => {
            return res.data;
        });
    }
}
