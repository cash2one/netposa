...
class ElectronicFenceService {
    constructor() {
        this.LOGGER = log4js.getLogger("ElectronicFenceService");
    }
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            let res = yield Promise.all([
                ElectronicFence_1.default.getPosaDPJavaCache(),
                BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.DeviceRelationDao).findListByWhere([
                    ...
                    WhereLib_1.EqualAndWhere(FildNameLib_1.FildNameLib.RelatedObjectType, Table_Map_1.TableMap.Rfid),
    ...
    edit(models) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let oldModelRes = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.RfidDao).findByID(models.ID);
            ...
            let r1 = yield ElectronicFenceService.updateElectronicFence(model);
            let r2, r3;
            ...
            if (p && p.length > 0) {
                ...
                newpoint.LayerType = LayerType_1.LayerType.ElectronicFence.value;
                newpoint.ObjectType = ObjectType_1.ObjectType.ElectronicFence.value;
            ...
            if (r && r.length > 0) {
                ...
                newRelation.RelatedObjectType = Table_Map_1.TableMap.Rfid;
                newRelation.Type = ObjectType_1.ObjectType.ElectronicFence.value;
    ...
    changeAreaId(models) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let efenceList = yield ElectronicFenceService.getElectronicFenceForIds(ids);
            efenceList.forEach((item) => {
                item.AreaID = maps[item.ID].areaId;
            });
            let result = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.RfidDao).updateList(efenceList);
            if (!result) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            models.forEach((model) => __awaiter(this, void 0, void 0, function* () {
                if (model.deviceReId) {
                    ...
                    relation.RelatedObjectId = model.id;
                    relation.RelatedObjectType = Table_Map_1.TableMap.Rfid;
                    relation.Type = ObjectType_1.ObjectType.ElectronicFence.value;
    ...
    static updateElectronicFence(model) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.RfidDao).update(model)
                .then((res) => __awaiter(this, void 0, void 0, function* () {
                return res.data;
            }));
        });
    }
    static getElectronicFenceForIds(ids) {
        return BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.RfidDao).findListByID(ids)
            .then((res) => {
            return res.data;
        });
    }
}
exports.ElectronicFenceService = ElectronicFenceService;
