...
class CameraExt {
    static getPosaDPJavaCache(keyword) {
        return __awaiter(this, void 0, void 0, function* () {
            let param = {
                searchType: SearchType_1.SearchType.Camera.value,
            };
            let res = yield BeanHelper_1.BeanHelper.getDao(DaoType_1.DaoType.AreaDao).findAreaResourceCascadeList(param);
            let result = [];
            if (Array.isArray(res.data)) {
                let r = res.data;
                let treeType = TreeType_1.TreeType.camera.value, getIcon = TreeType_1.GetCameraIconByCameraType;
                r.forEach((item) => {
    ...
    static getCameraForMap() {
        return __awaiter(this, void 0, void 0, function* () {
            let res = yield CameraExt.getPosaDPJavaCache();
            let result = {};
            if (Array.isArray(res.data)) {
...
CameraExt.LOGGER = log4js.getLogger("CameraExtCache");
exports.default = CameraExt;
